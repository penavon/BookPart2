...
type
   ...
   TSymbolTable = class (TObjectList<TSymbol>)
      ...
      public
        ...
        function addSymbol (fValue : TUserFunction) : integer; overload;
        ...
        procedure checkForExistingData (index : integer);
...
function TSymbolTable.addSymbol (fValue : TUserFunction) : integer;
var symbol : TSymbol;
begin
